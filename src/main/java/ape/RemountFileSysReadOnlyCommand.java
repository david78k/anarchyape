...
/**
 * This command remounts the root filesystem as read only.  This is done with the sysrq trigger.
 ...
 *
 */
public class RemountFileSysReadOnlyCommand extends ApeCommand
{
	...
	public RemountFileSysReadOnlyCommand()
	{
		...
		.withValueSeparator()
        .withDescription("Remounts all filesystems as read-only")
        .withLongOpt("remount")
        .create("r");
	}
	...
	/**
	 * Get the option of RemountFileSysReadOnlyCommand
	 */
	...
	/**
	 * Get the long flag for RemountFileSysReadOnlyCommand
	 */
